  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    $PHPMAILER_LANG = array(
      'provide_address' => 'É necessário informar ao menos 1 endereço de e-mail.',
      'mailer_not_supported' => ' mailer não suportado.',
      'execute' => 'Não foi possível executar: ',
      'instantiate' => 'Não foi possível instanciar a função de e-mail.',
      'authenticate' => 'Não foi possível autenticar no servidor SMTP.',
      'from_failed' => 'O seguinte rementente falhou: ',
      'recipients_failed' => 'Os seguintes destinatários falharam: ',
      'data_not_accepted' => 'Dados não aceitos pelo servidor SMTP.',
      'connect_host' => 'Não foi possível conectar ao servidor SMTP.',
      'file_access' => 'Não foi possível acessar o arquivo: ',
      'file_open' => 'Não foi possível abrir o arquivo: ',
      'encoding' => 'Enconding desconhecido: ',
      'signing' => 'Erro de assinatura: ',
      'smtp_error' => 'Erro de servidor SMTP: ',
      'empty_message' => 'O corpo da mensagem está vazio',
      'invalid_address' => 'Endereço inválido',
      'variable_set' => 'Não foi possível set ou reset da variável: '
    );
